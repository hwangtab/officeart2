    ...
    <footer className="bg-primary text-text-on-primary text-sm py-8 mt-16"> {/* Apply new theme colors */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div> {/* Removed flex flex-col */}
          ...
          {/* Adjust focus ring for new background */}
          <div className="flex items-center leading-normal"><a href="mailto:CONTACT@KOSMART.ORG" className="hover:underline focus:outline-none focus:ring-1 focus:ring-offset-primary focus:ring-white rounded transition-colors duration-200">CONTACT@KOSMART.ORG</a></div>
          {/* Adjust focus ring for new background */}
          <div className="flex items-center leading-normal"><span className="mr-1">TEL :</span> <a href="tel:02-764-3114" className="hover:underline focus:outline-none focus:ring-1 focus:ring-offset-primary focus:ring-white rounded transition-colors duration-200">02-764-3114</a></div>
