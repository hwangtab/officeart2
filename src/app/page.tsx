...
export const metadata: Metadata = {
  title: '오피스아트: 영등포•불광 프리미엄 공유오피스 | 비상주 사무실',
  description: '영등포구청역 5분, 불광역 2분. 정기 이용권 월 25만원, 비상주 사무실 월 3.3만원. 180만원 프리미엄 의자, L형 책상, 사업자등록 서비스까지 제공하는 창작자 특화 공유오피스입니다.',
  keywords: ['오피스아트', '영등포 공유오피스', '불광 공유오피스', '비상주 사무실', '사업자등록', '프리미엄 의자', '공유오피스', '코워킹스페이스', '창작자'],
  openGraph: {
