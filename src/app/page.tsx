...
export const metadata: Metadata = {
  title: '오피스아트: 합리적 가격으로 즐기는 최고의 업무 환경', // Add specific title
  description: '프리랜서를 위한 최고의 업무 환경, 오피스아트입니다. 180만원대 프리미엄 의자, 넓은 L형 책상, 집중 환경, 크리에이터 커뮤니티를 경험하세요.', // Improved description
