    ...
    <main className="flex min-h-screen flex-col items-center py-16 px-4 bg-light-gray">
      <div className="w-full max-w-5xl mx-auto">
        ...
        <Card className="mb-16">
          <SectionTitle as="h2" size="xlarge" className="text-center">오피스아트 입주 크리에이터</SectionTitle>
        ...
        <section className="mb-16">
          {/* Use SectionTitle */}
          <SectionTitle as="h2" size="xlarge" className="text-center">네트워킹 및 협업 기회</SectionTitle>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Regular Meetups - Use Card */}
            <Card>
              {/* Use accent-blue for icon, primary text color */}
              <h3 className="text-xl font-bold mb-4 flex items-center text-text-primary"><CalendarIcon className="h-5 w-5 mr-2 text-accent-blue" /> 정기 모임 및 이벤트</h3>
              {/* Use secondary text color */}
              <ul className="list-disc list-inside space-y-2 text-text-secondary text-sm pl-7">
            ...
            <Card>
              {/* Use accent-blue for icon, primary text color */}
              <h3 className="text-xl font-bold mb-4 flex items-center text-text-primary"><UsersIcon className="h-5 w-5 mr-2 text-accent-blue" /> 잠재적 협업 기회</h3>
              {/* Use secondary text color */}
              ...
              {/* Use secondary text color */}
              <ul className="list-disc list-inside space-y-1 text-xs text-text-secondary pl-5">
        ...
        {/* Use Card and SectionTitle */}
        <Card className="mb-16">
          <SectionTitle as="h2" size="xlarge" className="text-center">한국스마트협동조합 연계 혜택</SectionTitle>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            {/* Cooperative Intro */}
            {/* Use border-border-light */}
            <div className="md:col-span-1 border-r-0 md:border-r md:pr-8 border-border-light">
              {/* Use accent-blue for icon, primary text color */}
              <h3 className="text-xl font-bold mb-4 flex items-center text-text-primary"><BuildingLibraryIcon className="h-5 w-5 mr-2 text-accent-blue" /> 한국스마트협동조합 소개</h3>
              {/* Use secondary text color */}
              ...
              <ul className="text-xs text-text-secondary space-y-1 pl-5">
                  <li><span className="font-medium text-text-primary">설립 목적:</span> 예술인 권익 보호, 생활 안정 및 예술활동 지원</li>
                  <li><span className="font-medium text-text-primary">조합원 규모:</span> 약 600명 (2024년 기준)</li>
              </ul>
            </div>
            {/* Provided Services */}
            <div className="md:col-span-2">
              {/* Use accent-blue for icon, primary text color */}
              <h3 className="text-xl font-bold mb-4 flex items-center text-text-primary"><SparklesIcon className="h-5 w-5 mr-2 text-accent-blue" /> 오피스아트 입주 시 제공 가능 부가 서비스</h3>
              {/* Use secondary text color */}
              <ul className="list-disc list-inside grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-text-secondary text-sm pl-7">
                <li>예술인 저금리 대출</li>
                <li>예술활동증명 신청 지원</li>
                <li>종합소득세 신고 지원</li>
