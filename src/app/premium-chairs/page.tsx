    ...
    <main className="flex min-h-screen flex-col items-center py-16 px-4">
      <div className="w-full max-w-5xl mx-auto">
        ...
        <section className="mb-16">
          <SectionTitle as="h2" size="xlarge" className="text-center">오피스아트가 제공하는 의자</SectionTitle>
          <Card className="mb-12 flex flex-col md:flex-row items-start gap-8">
            <div className="md:w-1/2 w-full relative h-80 rounded-lg overflow-hidden">
               <Image src="/images/gallery/steelcase-think.jpg" alt="스틸케이스 씽크 의자" fill style={{ objectFit: 'contain' }} />
            </div>
            <div className="md:w-1/2 w-full">
              <h3 className="text-2xl font-bold mb-4">스틸케이스 씽크 (Think)</h3>
              <p className="text-text-secondary mb-4">인체공학적 설계와 뛰어난 조절 기능으로 최상의 편안함을 제공합니다.</p>
              <h4 className="font-semibold mb-2 text-text-primary">주요 특징:</h4>
              <ul className="list-disc list-inside mb-4 space-y-1 text-sm text-text-secondary">
              ...
              <a href="https://www.steelcase.com/products/office-chairs/think/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm inline-flex items-center gap-1">
                 <ExternalLinkIcon className="h-4 w-4" /> 공식 홈페이지 보기
              </a>
            </div>
          </Card>
          <Card className="flex flex-col md:flex-row-reverse items-start gap-8">
             <div className="md:w-1/2 w-full relative h-80 rounded-lg overflow-hidden">
               <Image src="/images/gallery/humanscale-freedom.jpg" alt="휴먼스케일 프리덤 의자" fill style={{ objectFit: 'contain' }} />
            </div>
            <div className="md:w-1/2 w-full">
              <h3 className="text-2xl font-bold mb-4">휴먼스케일 프리덤 (Freedom)</h3>
              <p className="text-text-secondary mb-4">자동 조절 시스템과 미니멀한 디자인으로 직관적인 편안함을 선사합니다.</p>
               <h4 className="font-semibold mb-2 text-text-primary">주요 특징:</h4>
              <ul className="list-disc list-inside mb-4 space-y-1 text-sm text-text-secondary">
              ...
              <a href="https://www.humanscale.com/products/seating/freedom-headrest-executive-chair" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm inline-flex items-center gap-1">
                 <ExternalLinkIcon className="h-4 w-4" /> 공식 홈페이지 보기
              </a>
            </div>
          </Card>
        ...
        <Card className="mb-16">
          <SectionTitle as="h2" size="xlarge" className="text-center">왜 프리미엄 의자일까요?</SectionTitle>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Comparison Chart */}
            <div className="h-full flex flex-col">
              <h3 className="text-xl font-bold mb-4 text-center text-text-primary">일반 의자 vs 프리미엄 의자</h3>
              <PremiumChairsClient />
            </div>
            {/* Comparison Table - Use Card */}
            <Card className="h-full flex flex-col overflow-x-auto">
              <h3 className="text-xl font-bold mb-4 text-center text-text-primary">카페 작업 vs 오피스아트</h3>
              <div className="overflow-x-auto flex-grow h-full">
                 <table className="min-w-full border border-border-light text-sm h-full"><thead>
        ...
        <section className="text-center mb-16">
          <SectionTitle as="h2" size="xlarge" className="text-center">월 25만원으로 누리는 가치</SectionTitle>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="flex flex-col items-center">
              <ValueIcon className="h-8 w-8 mb-3 text-success-green" />
              <h3 className="text-xl font-bold mb-3 text-text-primary">180만원대 의자를 월 25만원에</h3>
            ...
            <Card className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-text-primary">허리 건강을 지키는 선택</h3>
              <p className="text-text-secondary mb-4 text-sm">
