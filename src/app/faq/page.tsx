...
const nonResidentFaqData = [
  ...
  },
  {
    ...
    answer: "우편물이 도착하면 즉시 연락드리며, 직접 방문하여 수령하시거나 택배 발송도 가능합니다. (택배비 별도)",
  },
  {
    question: "계약 기간이 있나요?",
  ...
  {
    question: "두 지점 중 어디를 선택해야 하나요?",
    answer: "접근성이 좋은 곳을 선택하시면 됩니다. 서비스 내용과 가격은 동일하며, 우편물 수령 등을 고려하여 편리한 지점을 선택하세요.",
  },
  {
    question: "추가 비용이 있나요?",
    answer: "월 3.3만원 외에 우편물 택배 발송비, 전화응답 서비스(옵션) 등이 별도입니다. 기본 서비스는 추가 비용이 없습니다.",
  },
  {
    question: "비상주사무실과 정기 이용권의 차이는 무엇인가요?",
    answer: "비상주사무실은 주소 제공만 받는 서비스이고, 정기 이용권은 실제 작업공간을 이용하는 서비스입니다. 비상주사무실 이용자도 회의실을 할인가로 이용할 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    answer: "일반적인 사업자등록과 동일하게 관할 세무서에 신고하시면 됩니다. 필요한 서류는 임대차계약서 사본을 제공해드립니다.",
  },
];
