      ...
      <div className="w-full max-w-5xl mx-auto">
        ...
        <Card className="mb-16 flex flex-col md:flex-row items-center gap-12"> {/* Removed bg, p, rounded, shadow */}
          ...
          <div className="md:w-2/3 w-full">
            ...
            <SectionTitle as="h2" size="xlarge" iconLeft={<CoffeeIcon className="h-7 w-7 text-accent-blue" />} className="mb-4">프리미엄 커피 무제한</SectionTitle>
            ...
            {/* Adjust text color */}
            <ul className="list-disc list-inside text-sm text-text-secondary space-y-1 pl-5">
        ...
        <Card className="mb-16 flex flex-col md:flex-row-reverse items-center gap-12"> {/* Removed bg, p, rounded, shadow */}
          ...
          <div className="md:w-2/3 w-full">
            {/* Use SectionTitle, adjust size/margin, add icon color */}
            <SectionTitle as="h2" size="xlarge" iconLeft={<PrinterIcon className="h-7 w-7 text-accent-blue" />} className="mb-4">A3 컬러 복합기 무료 이용</SectionTitle>
        ...
        <Card className="mb-16"> {/* Removed bg, p, rounded, shadow */}
          {/* Use SectionTitle, adjust size/margin, add icon color */}
          <SectionTitle as="h2" size="xlarge" iconLeft={<WifiIcon className="h-7 w-7 text-accent-blue" />} className="text-center mb-6">초고속 네트워크 환경</SectionTitle>
        ...
        <section className="mb-16">
           {/* Use SectionTitle, adjust size/margin, add icon color */}
           <SectionTitle as="h2" size="xlarge" iconLeft={<FacilitiesIcon className="h-7 w-7 text-accent-blue" />} className="text-center mb-8">추가 편의 시설</SectionTitle>
